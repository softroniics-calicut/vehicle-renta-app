...
class _TaxiViewState extends State<TaxiView> {
   Future<dynamic> getData() async {
    ...
    var res = await post(Uri.parse('${Con.url}taxi-view.php'), body: data);
    print(res.body);
          ...
          builder: (context,snap) {
            ...
            return ListView(children: [
              Container(
                height: 250,
                child: Image.network(
'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT10HT0yKbE5tpLd-Lg82BlF7L_m1g_7mN5xb6oUpyp&s'),              ),
              Padding(
